  ...
  return (
      <div className="container about flex-column">
        ...
        <div className="about-info">
          ...
          I'm a passionate Frontend Developer with 3 years of experience turning ideas into responsive, user-friendly web interfaces. I specialize in converting designs into clean, efficient code using HTML, CSS, JavaScript, and Bootstrap. Let's build something amazing together!"
