                ...
                <div className={"header flex-column " + (showHeader && " show-header")} >                      
                    ...
                    <ul className={"header-list flex-column" }>
                        ...
                        <li className="header-list-item " onClick={hideHeaderFun}>
                            <NavLink to="/about" > <FontAwesomeIcon icon="fa-solid fa-user " className="icon" /> 
                                <span> about me </span>  </NavLink>
                        </li> 
                        <li className="header-list-item " onClick={hideHeaderFun}>
                            <NavLink to="/services"> <FontAwesomeIcon icon="fa-solid fa-code" className="icon" />
                             <span> services </span> 
                            </NavLink>
                        </li>            
                    </ul>
